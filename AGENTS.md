# Aktueller Projektstand – 15. September 2026

- Neuer Nutzerauftrag „Please run the proposed focused comparison“: **15.09.2026 um 08:11:45 Europe/Berlin gestartet**, harte Frist **14:01:33**. Worktree `/Users/timokruth/Projekte/SLM-focused-optimization`, Branch `codex/focused-optimization`, Code `8ab004d`; aktive Sitzung `runs/focused-fp32-12000-2026-09-15/` dort, `status.json`/`direct-status.json` verbindlich. Sechs FP32-Läufe mit identischen 12.000 Updates (sync1/sync4, drei gleiche Datenreihenfolgen), gleicher Elterncheckpoint/Adam/Batch/LR. Frische 570er-Suite aus 23 Quellen, 490 korrektheitsbewertete Aufgaben; 34 Dialogaufgaben statt 12, Quoref frisch erschöpft und weiterhin in alten 384/288-Diagnosesuiten. Null Überschneidung mit Training/34 früheren Suiten. 19 Auswertungen, unveränderte Qualitäts-/Ressourcenkriterien. 6h-Gesamtobergrenze einschließlich Vorbereitung: 612s Vorbereitung/Startreserve, 20.988s Laufbudget; kein altes Restbudget addiert. 59 CPU-Tests, echte Adam-/Sampler-Kontrollen und Vier-Update-Endpunkt/Checkpoint-Smoke bestanden. Netzstrom, Light-Monitoring/PowerWatch, exklusive GPU-Lease; keine automatische Übernahme, Wiederholung oder Verlängerung. Details `FOCUSED_FP32_START.md`; Abbruch durch STOP im neuen Laufverzeichnis.

- Konservativer Vergleich am **15.09.2026 um 05:27 Europe/Berlin abgeschlossen**, alle sechs Trainings und 24 Folgeauswertungen, kein weiterer Fehler, keine Übernahme. Nutzerauftrag „Do the analysis“ rein CPU-basiert erledigt: `CONSERVATIVE_RESULT_ANALYSIS.md`, reproduzierbar über `experiments/analyze_conservative.py`; lokale Details `runs/conservative-analysis-2026-09-15-verified/`. Bei 8.192 identischen Updates null Korrektheitsregressionen und zwei Verbesserungen in 1.596 Vergleichen (532 Aufgaben × drei Datenreihenfolgen), mediane Beschleunigung bis zu diesem Stand 2,20%. Am Zeitende Bestätigung −2,508 Prozentpunkte bei 277–586 zusätzlichen Updates; zwei konkrete Aufgaben regressieren in allen drei Reihenfolgen. Spätere identische Updates fehlen als Endpunkt, daher Zusatztraining und kumulierte numerische Unterschiede nicht getrennt. Kleine Fähigkeitsstichproben und systemweite Swap-ins begrenzen Schlussfolgerungen; alte Kriterien nicht geändert. 26 Auswertungen und 76 Datei-Hashes geprüft, kein neues Training oder Startauftrag. Nächste Empfehlung: späteren gemeinsamen Update-Stand prüfen, keine automatische Folgeausführung.

- Zweiter Langzeitblock vollständig abgeschlossen am **14.09.2026 um 23:55:05 Europe/Berlin**: acht Trainings und 33 Auswertungen, eingefrorene Eingaben laut Supervisor unverändert. Ergebnisse auf Nutzerauftrag in `main` versioniert: `results/2026-09-15/INDEX.md`, Einordnung und vorgeschlagene nächste Schritte in `ERKENNTNISSE.md`. Keine Variante erfüllt sämtliche Kriterien gegenüber A (konstant LR 3e-5); Kosinus im Mittel nur +0,24 Prozentpunkte mit wechselndem Vorzeichen. Gesamtverbrauch 66.390,316s aus 86.400s, keine Nutzung der Restreserve, keine Modellübernahme oder neue Trainingsfreigabe. Historische Start-/Pausenangaben unten bleiben als Protokoll erhalten; der separate konservative FP32-Vergleich ist davon unabhängig.

- Nutzerauftrag „why is the run paused? fix and continue or restart please“: konservativer FP32-Vergleich am **15.09.2026 um 01:47:37 Europe/Berlin** repariert neu gestartet. Harte Frist **06:44:47**, Restbudget **17.830s** nach 3.173s altem Versuch und 597s Vorbereitung/Startreserve; kein neues 6h-Budget, Pause ausgenommen. Aktive Sitzung `/Users/timokruth/Projekte/SLM-conservative-recovery/runs/conservative-fp32-recovery-2026-09-15/`, Code `781ccb4`, Branch `codex/conservative-recovery`. Ursache: erstes Baseline-Training erreichte 16.384 Updates nicht vor Zeitlimit; Exception vor finalem Checkpoint, kein gemeldeter GPU-Hang. Historische Sitzung unverändert STOP-gesperrt. Alle sechs langen Läufe fair vom selben Elternmodell neu: je 2.100s, gemeinsamer Qualitätsstand bei 8.192 Updates, unveränderte FP32-/Adam-/Daten-/LR-Eingaben und Qualitätskriterien, drei Datenreihenfolgen, beide 384/288-Suiten. 20 Replay-Kontrollen und Elternauswertungen übernommen, 93 Kopien verifiziert, frische echte Checkpoint-Kontrolle vor Training. Fehlender Endpunkt sichert jetzt zuerst Modell/Adam/Sampler und schreibt pausierten Status. 55 CPU-Tests bestanden. Netzstrom, Light-Monitoring, PowerWatch; keine Modellübernahme oder automatische Verlängerung. Status/Frist in neuer Sitzung verbindlich; Details `CONSERVATIVE_RECOVERY_START.md`. Langzeitblock 2 bereits 14.09. um 23:55 erfolgreich abgeschlossen; nicht neu gestartet.
