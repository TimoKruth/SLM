...
- Hardware-Optimierungs-Unterprojekt jetzt ausdrücklich freigegeben („go for the first screen“): `/Users/timokruth/Projekte/SLM-optimization`, Branch `codex/hardware-optimization`, Einstieg `OPTIMIERUNG.md`. Erste 60-Worker-Messreihe mit maximal 3600s ab Start. Aktive einmalige CPU-Queue wartet auf erfolgreichen Abschluss und Prozessende von `long-horizon-round2-2026-09-11` sowie exklusive GPU. Status im Optimierungs-Worktree: `runs/optimization-screen-2026-09-11/queue-status.json`, nach Start `status.json`. Beide Optimierungs-STOPs entfernt; Queue verfällt am 12.09.2026 um 19:31:18 Europe/Berlin. Eingefrorene aktive v4-Kampagne, vorbereitete v5/v6-Daten und andere Budgets unverändert. Keine automatische Verlängerung oder Modellübernahme.
