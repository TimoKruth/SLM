...
SUPERVISOR_MODULES = {'fresh47.campaign','long_study.campaign','long_study.resume','study.campaign', 'study.queue','research.campaign','slm.sixhour', 'slm.overnight', 'slm.campaign'}
