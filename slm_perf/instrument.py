...
MODULES.update({'study.health','long_study.trial','long_study.campaign','long_study.resume','long_study.report'})
MODULES.update({'study.queue', 'study.campaign', 'study.trial'})
MODULES.update({'research.trial', 'research.campaign'})
