...
Der unabhängige Bestätigungsversuch bestand alle Zustands- und Loss-Prüfungen innerhalb der vorab festgelegten Toleranzen; Bitgleichheit wurde nicht erreicht. `light`: 0,61146 s/Schritt gegenüber 0,60672 s ohne Monitoring, beobachtet +0,78 %. Die Wiederholungsbereiche überlappen. `detail`: beobachtet +1,97 %. Metal-Aufzeichnung erfolgreich. Artefakte: `runs/broad-monitoring-confirmation-2026-09-07/`.
