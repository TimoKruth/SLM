...
def command(argv, defaults=None, session=None):
    ...
    parser.add_argument('--module', default='slm.sixhour', choices=['slm.sixhour', 'slm.overnight', 'slm.train', 'slm.report', 'slm.code_eval', 'slm.interface_eval', 'slm.broad_eval', 'slm.validation', 'slm.campaign', 'future_eval.analyze', 'future_eval.prepare', 'future_eval.queue', 'random_search.pilot', 'next_run.performance', 'research.trial', 'research.campaign', 'study.queue', 'study.campaign', 'study.trial', 'study.health', 'long_study.trial', 'long_study.campaign', 'long_study.resume'])
